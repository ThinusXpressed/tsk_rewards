...
export default function ProfilePictureUpload({ participantId, profilePicture, initial }: Props) {
  ...
  return (
    <>
      <div className="relative h-full w-full">
        ...
        {src && !uploading && (
          <button
            ...
            className="absolute -top-1.5 -right-1.5 flex h-5 w-5 items-center justify-center rounded-full bg-red-500 text-white hover:bg-red-600 z-10"
        ...
        {showMenu && (
          <>
            ...
            <div className="absolute left-full top-0 z-30 ml-2 w-44 rounded-lg border border-gray-200 bg-white shadow-lg overflow-hidden">
              ...
              <button
                type="button"
                onClick={() => { setShowMenu(false); setShowWebcam(true); }}
                className="flex w-full items-center gap-2 px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50"
              >
                <svg className="h-4 w-4 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4">
          <div className="w-full max-w-sm rounded-xl bg-white shadow-xl overflow-hidden">
            ...
            <div className="relative bg-black aspect-square">
              ...
              {webcamError && (
                <div className="absolute inset-0 flex items-center justify-center p-4 text-center text-red-300 text-sm">
                  {webcamError}
                </div>
              )}
            </div>
            ...
            <div className="flex gap-2 p-4">
              ...
              <button
                ...
                className="flex-1 rounded-lg bg-orange-600 py-2 text-sm font-medium text-white hover:bg-orange-700 disabled:opacity-40"
              >
                Capture
              </button>
            </div>
      ...
      {/* Off-screen canvas for webcam capture */}
